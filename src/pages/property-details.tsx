          ...
          <Card className="card-hover">
            ...
            <CardContent className="space-y-2">
              <Button className="w-full justify-start" asChild>
                <Link to={`/dashboard/payments/new?propertyId=${property.id}`}>Record Payment</Link>
              </Button>
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to={`/dashboard/tenants/new?propertyId=${property.id}`}>Add Tenant</Link>
              </Button>
              <Button variant="outline" className="w-full justify-start" asChild>
                <Link to={`/dashboard/properties/${property.id}/lease`}>
