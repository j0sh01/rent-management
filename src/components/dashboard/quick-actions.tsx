      ...
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-2">
          <Button asChild variant="outline" className="h-auto py-4 justify-start">
            <Link to="/dashboard/properties/new" className="flex flex-col items-start gap-1">
          ...
          <Button asChild variant="outline" className="h-auto py-4 justify-start">
            <Link to="/dashboard/tenants/new" className="flex flex-col items-start gap-1">
              <div className="flex items-center">
          ...
          <Button asChild variant="outline" className="h-auto py-4 justify-start">
            <Link to="/dashboard/payments/new" className="flex flex-col items-start gap-1">
              <div className="flex items-center">
          ...
          <Button asChild variant="outline" className="h-auto py-4 justify-start">
            <Link to="/dashboard/reports" className="flex flex-col items-start gap-1">
              <div className="flex items-center">
